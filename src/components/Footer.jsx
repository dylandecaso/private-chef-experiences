    ...
    <footer id="contact" className="border-t border-line bg-ink">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:grid-cols-2 lg:grid-cols-3 lg:px-8">
        ...
        <div>
          ...
          <p className="mt-5 max-w-xs text-sm leading-relaxed text-muted">
            Elevated culinary experiences crafted with premium ingredients and
            a personal touch — in the comfort of your home.
          </p>
        </div>
      ...
      <div className="border-t border-line">
        <p className="mx-auto max-w-7xl px-5 py-6 text-center text-xs tracking-wide text-muted lg:px-8">
          © {new Date().getFullYear()} PRIVATE CHEF experiences. All rights
          reserved.
        </p>
      </div>
    </footer>
